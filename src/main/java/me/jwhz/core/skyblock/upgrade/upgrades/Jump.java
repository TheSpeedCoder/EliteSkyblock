...
public class Jump extends Upgrade {
    ...
    public ItemStack getItem(Player player, Island island) {
        ...
        meta.setDisplayName(ChatColor.YELLOW + "" + ChatColor.BOLD + "Kangaroo Hops");

        ArrayList<String> lore = new ArrayList<>();

        lore.add("");
        lore.add(ChatColor.GRAY + "Gives leaping 2 while");
        lore.add(ChatColor.GRAY + "you are on the island.");
        lore.add("");
        if (island.upgrades.hasPurchased(new Jump()))
            ...
            lore.add(ChatColor.GRAY + "Gives leaping 2 while on island");
            lore.add("");
